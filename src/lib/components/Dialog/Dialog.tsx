    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        <div className='fixed inset-0 z-0 flex items-start justify-center sm:items-center'>
          ...
          <Dialog.Content className='fixed z-0 flex w-5/6 items-center justify-center  gap-4 rounded-b-lg border bg-background p-6 shadow-lg animate-in data-[state=open]:fade-in-90 data-[state=open]:slide-in-from-bottom-10 data-[state=open]:sm:slide-in-from-bottom-0'>
